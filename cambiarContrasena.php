      ...
      <table width="470" border="0" align="center" cellpadding="0" cellspacing="0" style="padding-left:5px;padding-right:5px;padding-bottom:10px">
        ...
        <tr>
          ...
          <span style="font-size:13px;color:#212529;font-family:Arial,Helvetica,sans-serif;font-weight:bold">
            <p>Criptocash <span class="il">cambio</span> de <span class="il">contraseña</span>.</p>
          </span>
          </td>
        </tr>
        ...
        <tr bgcolor="#E8E8E8">
              <td style="padding:20px;font-size:12px;line-height:17px;color:#c6d4df;font-family:Arial,Helvetica,sans-serif">
                      <p style="padding-bottom:10px;color:#212529">Ha solicitado cambiar la contraseña de su cuenta de Criptocash.<span style="color:#212529;font-weight:bold"> Para hacerlo por favor siga este siguente enlace. <a href="www.criptocash.com"> Click aqui</a> </span></p>
                  <p style="padding-bottom:10px;color:#212529"><span style="color:#212529;">Para cambiar su contraseña, se le pedirá que ingrese la direccion de correo electronico que utiliza para el ingreso a Criptocash y una nueva contraseña.</span>Esto es para verificar su identidad y asegurar de que solo usted tengo<span class="il">acceso</span> a su <span class="il">cuenta</span>.</p>
                  <p style="color:#61696d">Si tiene alguna pregunta <span class="il">por </span>favor. Ingresar a los enlaces de abajo.</p>
              </td>
